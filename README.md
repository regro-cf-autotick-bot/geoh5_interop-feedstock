...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/geoh5_interop-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/geoh5_interop-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add geoh5-interop
# for installing globally
pixi global install geoh5-interop
```
...
It is possible to list all of the versions of `geoh5-interop` available on your platform:
...
```
pixi search geoh5-interop --channel conda-forge
```
